...
7. **Подключитеесь к серверу `s2-deb`**.
...
9. **Подключитеесь к серверу `s1-alma`**
...
10.   **Подключитеесь к серверу `s2-deb`**. Проверьте открытые порты на сервере **s1-alma**. Порт в списке появился, но статус у него **`closed`**. Порт на брэндмауэре открыт, но служба не слушает на нем соединение.
...
20. **Подключитеесь к серверу `s1-alma`**.
...
24. **Подключитеесь к серверу `s2-deb`**. Установите пакет `system-config-printer`. 
...
32. **Подключитеесь к серверу `s1-alma`**. Найдите файл pdf в каталоге **/var/spool/cups-pdf/...** и скопируйте его на сервер **s2-deb** в каталог **/home/sa/**
```
...
33. **Подключитеесь к серверу `s2-deb`**.
